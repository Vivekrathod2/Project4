...
public class HTMLUtility {
		...
		public static String getList(String name, String selectedVal,
			  ...
			  StringBuffer sb = new StringBuffer("<select style='width: 305px;  height: 25px;' class='form-control' name='" + name + "'>");
		        ...
		        if (select) {
		            ...
		            sb.append("<option style='width: 305px;  height: 30px;' selected value=''>--------------------Select-------------------</option>");
		        }
		    ...
		    public static String getList(String name, String selectedVal, List list) {
		        ...
		        StringBuffer sb = new StringBuffer("<select style='width: 305px;  height: 30px;' class='form-control' name='" + name + "'>");

		        boolean select=true;
		        if (select)
		        {

		            sb.append("<option style='width: 305px;  height: 25px;' selected value=''>----------------------Select---------------------------</option>");
		        }
