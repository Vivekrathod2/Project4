<%@page import="in.co.sunrays.ctl.StudentListCtl"%>
...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<table width="100%">
				<tr>
					<td align="center"><label class="p1"> FirstName :</label> <input
						type="text" name="firstName" class="p2" placeholder = "First Name"
						value="<%=ServletUtility.getParameter("firstName", request)%>">&emsp;&emsp;
						&emsp;&emsp; <label class="p1">Email_Id :</label> <input
						type="text" name="email" class="p2" placeholder ="Email ID"
						value="<%=ServletUtility.getParameter("email", request)%>">&emsp;&emsp;

						<label class="p1">College Name</label> &emsp; <%=HTMLUtility.getList("collegeId", String.valueOf(bean.getCollegeId()), list1)%>&emsp;&emsp;


						<input type="submit" name="operation"
						value="<%=StudentListCtl.OP_SEARCH%>" style="padding: 5px;">&emsp;
						<input type="submit" name="operation"
						value="<%=StudentListCtl.OP_RESET%>" style="padding: 5px;"></td>
